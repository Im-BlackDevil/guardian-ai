  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-6xl">
        ...
        >
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-2 sm:mb-3 lg:mb-4 px-2">About BiasShield AI</h2>
          <p className="text-sm sm:text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto px-4">
        ...
        >
          <Card className="shadow-card border-primary/20 bg-gradient-to-r from-primary/5 to-accent/5">
            <CardContent className="p-4 sm:p-6 lg:p-8 text-center">
              <Heart className="h-10 w-10 sm:h-12 sm:w-12 lg:h-16 lg:w-16 text-primary mx-auto mb-3 sm:mb-4 lg:mb-6" />
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold mb-2 sm:mb-3 lg:mb-4">Our Mission</h3>
        ...
        <motion.div
          ...
          className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-8 sm:mb-12 lg:mb-16"
        >
          {stats.map((stat, index) => (
            ...
            >
              <div className="bg-card/80 backdrop-blur-sm border border-border rounded-xl p-3 sm:p-4 lg:p-6 shadow-card">
                <stat.icon className="h-5 w-5 sm:h-6 sm:w-6 lg:h-8 lg:w-8 text-primary mx-auto mb-2 sm:mb-3" />
                <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-primary mb-1">{stat.value}</div>
        ...
        <motion.div
          ...
          className="mb-8 sm:mb-12 lg:mb-16"
        >
          <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-center mb-6 sm:mb-8 lg:mb-12">Our Team</h3>
              ...
              >
                <Card className="h-full border-primary/20 bg-card/50 backdrop-blur-sm hover:border-primary/40 transition-all duration-300 hover:shadow-lg">
                  <CardContent className="p-4 sm:p-6 text-center">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 bg-primary/10 rounded-full mx-auto mb-3 sm:mb-4 flex items-center justify-center">
                      <Users className="h-6 w-6 sm:h-8 sm:w-8 lg:h-10 lg:w-10 text-primary" />
                    </div>
                    <h4 className="text-base sm:text-lg lg:text-xl font-semibold mb-1 sm:mb-2">{member.name}</h4>
                    <p className="text-xs sm:text-sm lg:text-base text-primary font-medium mb-2 sm:mb-3">{member.role}</p>
        ...
        {/* Values - More compact grid */}
        <motion.div
          initial={{ y: 30, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.6, delay: 0.8 }}
        >
          <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-center mb-6 sm:mb-8 lg:mb-12">Our Values</h3>
              ...
              >
                <Card className="h-full border-primary/20 bg-card/50 backdrop-blur-sm hover:border-primary/40 transition-all duration-300 hover:shadow-lg">
                  <CardContent className="p-3 sm:p-4 lg:p-6 text-center">
                    ...
                    <h4 className="text-sm sm:text-base lg:text-lg font-semibold mb-1 sm:mb-2">{value.title}</h4>
